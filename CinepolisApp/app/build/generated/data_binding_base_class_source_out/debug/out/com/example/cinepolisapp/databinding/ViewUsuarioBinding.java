...
public final class ViewUsuarioBinding implements ViewBinding {
  @NonNull
  ...
  private ViewUsuarioBinding(@NonNull ConstraintLayout rootView, @NonNull TabItem TabCarrito,
      @NonNull TabItem TabCartelera, @NonNull TabItem TabComida, @NonNull ScrollView panel,
  ...
  @NonNull
  public static ViewUsuarioBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ViewUsuarioBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.view_usuario, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ViewUsuarioBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ViewUsuarioBinding((ConstraintLayout) rootView, TabCarrito, TabCartelera,
          TabComida, panel, tabLayout);
    }
